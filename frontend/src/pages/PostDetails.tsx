  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <article className="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <div className="flex items-center justify-between text-sm text-gray-600 mb-6 border-b pb-4">
          ...
          {canEdit && (
            <div className="flex space-x-2">
              <a href={`/edit/${post._id}`} className="text-blue-600 hover:text-blue-800">Edit</a>
              <button className="text-red-600 hover:text-red-800">Delete</button>
            </div>
          )}
        </div>
        <div className="prose max-w-none text-gray-700 leading-relaxed">{post.content}</div>
      </article>

      <div className="bg-white rounded-lg shadow-md p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Comments ({post.comments.length})</h2>
        {isAuthenticated && (
